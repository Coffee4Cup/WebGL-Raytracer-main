...
const spheres = [
    new Sphere([0.0, 0.0, 4.0], 2.0, [1.0, 0.5, 0.5], 0),
    new Sphere([4.0, 0.5, -2.0], 2.0, [0.5, 1.0, 0.5], 1),
    new Sphere([-4.0, 0.3, -2.0], 2.0, [0.5, 0.5, 1.0], 0),
    new Sphere([-30.0, 3.0, -2.0], 3.0, [0.5, 0.5, 1.0], 2),
